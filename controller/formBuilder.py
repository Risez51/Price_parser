...
class FormBuilder:
    ...
    def append_cheescake_item(self, my_input):
        ...
        inputBuilder.InputBuilder(my_input, self.view_items).update_input_cheescake_label(file_data)
    ...
    def append_comparison_item(self, my_input):
        ...
        inputBuilder.InputBuilder(my_input, self.view_items).update_input_comparison_label(file_data)
